    ...
    <div class="flex min-h-screen">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-60 bg-white border-r border-slate-200 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col">
            ...
            <nav class="flex-1 px-3 pb-4 overflow-y-auto">
                ...
                <a href="{{ route('guru.peminjamans.index') }}" class="sidebar-link {{ request()->routeIs('guru.peminjamans.index') || request()->routeIs('guru.peminjamans.show') ? 'active' : '' }}">
                ...
                <a href="{{ route('guru.peminjamans.create') }}" class="sidebar-link {{ request()->routeIs('guru.peminjamans.create') ? 'active' : '' }}">
