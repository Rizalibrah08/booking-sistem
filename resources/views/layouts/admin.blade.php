...
<body class="min-h-screen bg-slate-50/80">
    <div class="flex min-h-screen">
        ...
        {{-- ═══ SIDEBAR ═══ --}}
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-60 bg-gradient-to-b from-brand-950 via-brand-900 to-slate-900 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out flex flex-col">
            {{-- Logo --}}
            <div class="px-5 py-5 flex items-center gap-3">
                <div class="w-9 h-9 bg-gradient-to-br from-brand-400 to-brand-600 rounded-lg flex items-center justify-center shadow-lg shadow-brand-500/25">
                ...
                <div class="min-w-0">
                    ...
                    <p class="text-brand-300/70 text-[10px] font-medium tracking-wide uppercase">Panel Admin</p>
                </div>
            </div>
            ...
            <div class="px-4 py-3 border-t border-white/[0.06]">
                <div class="flex items-center gap-2.5">
                    <div class="w-8 h-8 bg-gradient-to-br from-brand-400 to-brand-600 rounded-lg flex items-center justify-center text-white font-bold text-xs shadow">
